...
const PriceMonitoringScrapingClient: React.FC = () => {
  useLayoutEffect(() => {
    window.scrollTo(0, 0);
  }, []);
        ...
        <div className="w-full bg-transparent text-white pb-8 flex flex-col items-center text-center">
          <div className="max-w-4xl h-full bg-gradient-to-r from-[#013e84] to-[#0ea0c4] text-white font-semibold px-4 pb-3 sm:px-6 sm:pb-4 md:mt-[-20px] rounded-lg flex items-center justify-center gap-2 sm:gap-3">
            <span className="text-4xl sm:text-6xl md:text-7xl">
              Price Monitoring Scraping Services
            </span>
          </div>
          ...
          <motion.div className="w-full mt-10 md:mt-14 lg:mt-16 space-y-16 lg:space-y-20">
            ...
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 w-full max-w-7xl mx-auto items-center">
              ...
              >
                <Image
                  ...
                  alt="Real-time Price Monitoring Dashboard"
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Our price monitoring services deliver up-to-the-minute pricing
                  data from e-commerce sites, marketplaces, and competitors,
                  helping you make informed pricing decisions.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>
                      24/7 price tracking across thousands of products
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Automatic price change detection and alerts</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Historical price trends and analytics</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Stock availability monitoring</span>
                  </li>
                </ul>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 w-full max-w-7xl mx-auto items-center">
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Gain strategic insights with our advanced price monitoring
                  solutions that track pricing patterns, promotions, and
                  seasonal fluctuations across your market.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Price change history and volatility analysis</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Promotion and discount tracking</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>MAP (Minimum Advertised Price) monitoring</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Automated price change notifications</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Integration with your pricing strategy tools</span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                <Image
                  ...
                  alt="Dynamic Pricing Intelligence Dashboard"
                  className="w-full h-auto rounded-lg md:rounded-xl lg:rounded-2xl border-2 border-gray-200/10 shadow-2xl hover:scale-[1.01] transition-all duration-300"
                  width={600}
                  height={400}
                />
            ...
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 w-full max-w-7xl mx-auto items-center">
              ...
              >
                <Image
                  src="/Images/web scraping 1.jpg"
                  alt="Price Alert Notifications System"
                  className="w-full h-auto rounded-lg md:rounded-xl lg:rounded-2xl border-2 border-gray-200/10 shadow-2xl hover:scale-[1.01] transition-all duration-300"
                  width={600}
                  height={400}
                />
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Never miss a price change with our customizable alert system
                  that notifies you immediately when competitors adjust their
                  pricing.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Customizable price change thresholds</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>
                      Multiple notification channels (Email, SMS, API)
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Price drop and increase alerts</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Competitor out-of-stock notifications</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Daily/weekly price summary reports</span>
                  </li>
                </ul>
              </motion.div>
            </div>
...
export default PriceMonitoringScrapingClient;
