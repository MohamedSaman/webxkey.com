...
const WebScrapingAPIClient: React.FC = () => {
  useLayoutEffect(() => {
    window.scrollTo(0, 0);
  }, []);
          ...
          <motion.div className="w-full mt-10 md:mt-14 lg:mt-16 space-y-16 lg:space-y-20">
            ...
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 w-full max-w-7xl mx-auto items-center">
              ...
              >
                <Image
                  ...
                  alt="Web Scraping API Architecture"
              ...
              >
                <h3 className="text-2xl md:text-3xl font-bold mb-4">
                  RESTful Scraping API Endpoints
                </h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                  Our web scraping API services deliver structured data through
                  simple RESTful endpoints. Get real-time web data without
                  managing infrastructure, proxies, or CAPTCHAs.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>
                      Simple HTTP GET/POST requests for data extraction
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Automatic IP rotation and request throttling</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Built-in CAPTCHA solving and antibot bypass</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Response formats: JSON, XML, CSV</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Webhook support for asynchronous jobs</span>
                  </li>
                </ul>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 w-full max-w-7xl mx-auto items-center">
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Need a specialized scraping API? We build custom endpoints
                  tailored to your specific data requirements and target
                  websites.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Website-specific API endpoints</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Custom data transformation pipelines</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Authentication (API keys, OAuth)</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Automatic schema documentation</span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                <Image
                  ...
                  alt="Custom API Development Process"
                  className="w-full h-auto rounded-lg md:rounded-xl lg:rounded-2xl border-2 border-gray-200/10 shadow-2xl hover:scale-[1.01] transition-all duration-300"
                  width={600}
                  height={400}
                />
            ...
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 w-full max-w-7xl mx-auto items-center">
              ...
              >
                <Image
                  src="/Images/web scraping 1.jpg"
                  alt="API Performance Monitoring Dashboard"
                  className="w-full h-auto rounded-lg md:rounded-xl lg:rounded-2xl border-2 border-gray-200/10 shadow-2xl hover:scale-[1.01] transition-all duration-300"
                  width={600}
                  height={400}
                />
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Our fully managed scraping API solutions handle everything
                  from infrastructure to maintenance.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Automatic schema adaptation</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
                    <span>Automatic scaling during peak loads</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2">✓</span>
